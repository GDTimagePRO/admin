...
<head>
	<title></title>
	<link type="text/css" href="css/themes/genesys/jquery-ui.custom.min.css" rel="stylesheet" />
	<link type="text/css" href="css/genesys_design_wizard.css" rel="StyleSheet"/>	
...
<body>
	<div class = "form">
		<form method="post" id="form">
			<img src="images/logo/genesys_logo_desktop.png" alt="MasonRow" style="padding-left:95px"><br />
			<table style="padding-right:0px;padding-left:14px;margin: 0 auto;">
