        ...
        public ActionResult ConfirmOrder()
        {
            ...
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    ...
                    {
                        var variants = placeOrderResult.PlacedOrder.OrderProductVariants;
                        var designs = "";
                        foreach(var variant in variants){
                            if (variant.AttributeDescription.Contains(":"))
                            {
                                char[] delimiterChars = { ':' };
                        ...
                        var parameters = "orderId="+placeOrderResult.PlacedOrder.Id+"&designs="+designs;
                        string URI = "http://in-stamp.com.loucks51.arvixevps.com/masonrow/workstation/nopCompleted.php?" + parameters;
