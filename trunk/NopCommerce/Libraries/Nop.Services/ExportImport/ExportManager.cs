...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual string ExportOrdersToCSV(IList<Order> orders)
        {
            var sb = new StringBuilder();
            var stringWriter = new StringWriter(sb);
            var _orders = new List<UPSCSVOrder>();
            foreach(var o in orders){
                if (o != null)
                {
                    
                    var order = new UPSCSVOrder
                    {                     
                        ContactName = o.ShippingAddress.FirstName+" "+o.ShippingAddress.LastName,
                        CompanyOrName = !String.IsNullOrEmpty(o.ShippingAddress.Company) ? o.ShippingAddress.Company : o.ShippingAddress.FirstName + " " + o.ShippingAddress.LastName,
                        Address1 = o.ShippingAddress.Address1,
                        Address2 = o.ShippingAddress.Address2,
                        City = o.ShippingAddress.City,
                        State = o.ShippingAddress.StateProvince != null ? o.ShippingAddress.StateProvince.Abbreviation : "",
                        PostalCode = o.ShippingAddress.ZipPostalCode,
                        Country = o.ShippingAddress.Country.TwoLetterIsoCode,
            ...
            csv.Write(_orders, stringWriter,inputFileDescription);
        ...
        public virtual string ExportOrdersToUPSXML(IList<Order> orders)
        {
            ...
            foreach (var o in orders)
            {
                ...
                foreach (var variant in o.OrderProductVariants)
                {
