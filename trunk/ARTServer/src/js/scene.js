...
function SceneLayer(scene, name, drawables)
{
    if(!drawables) drawables = [];    
    ...
    this.clone = function()
    {
    	var newLayer = new SceneLayer(this.scene, this.name, drawables.slice(0));
    ...
    this.remove = function(drawable)
    {
        for(var i in drawables)
        {
            ...
            {                
                ...
                {
                	drawables.onRelease(this.scene.getCommonParams());
                }
...
function Scene(canvas, width, height)
{
	...
	this.colors = { ink : { name : 'Black', value : '000000' } };
    ...
    this.setState = function(state)
    {
    	if(state)
    	{
    		this.colors = state.colors ? state.colors : { ink : { name : 'Black', value : '000000' } };  
    	}
    	else
    	{
    		this.colors = { ink : { name : 'Black', value : '000000' } };
...
Scene.DEFAULT_BACKGROUND_COLOR = "#808080";
