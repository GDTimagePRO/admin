	...
	$(function() {
		...
		$('#select-element').imagemenu({
			select: function(e, ui) {
				...
				components.createComponent(_system.elements[ui.item.value]);
			}
		});
...
<body unselectable="on" class="unselectable" id="<?php echo ($container->simpleMode ? 'simple_mode' : ''); ?>">
	...
	<div class="wizard_frame">
		<div class="wizard_header">
            <div class="wizard_header_title"><img class="logo" src="<?php echo $ti->HOME_URL; ?>/images/logo/logo_desktop.png" alt="Genesys"></div>
