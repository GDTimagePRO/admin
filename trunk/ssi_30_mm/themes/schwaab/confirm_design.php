...
<body unselectable="on" class="unselectable">
	...
	<div class="wizard_frame">
		<div class="wizard_header">
			<div class="wizard_header_title"><img class="wizard_header_title_logo" src="<?php echo $ti->HOME_URL; ?>/images/logo/logo_desktop.png" alt="Genesys"></div>
