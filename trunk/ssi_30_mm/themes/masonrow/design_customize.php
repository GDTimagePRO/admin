...
<head>
	...
	$(function() {
        ...
        components.showMaxLengthAlert = true;
        ...
        $("#dialog_confirm_message").dialog({
            ...
            modal: true,
            buttons: {
                "Got it - Let's Get Started": function() {
                                                $( this ).dialog( "close" );
                                              }
            }
        }); 
...
<body unselectable="on" class="unselectable" id="<?php echo ($container->simpleMode ? 'simple_mode' : ''); ?>">
	...
	<div class="wizard_frame">
		<div class="wizard_header">
			...
			<?php if($container->simpleMode){ ?>
				<div class="wizard_header_title"><img class="logo" src="<?php echo $ti->HOME_URL; ?>/images/logo/MR_Logo_revised.png" alt="Mason Row"></div>
			<?php } else { ?>
				<div class="wizard_header_title"><img class="logo" src="<?php echo $ti->HOME_URL; ?>/images/logo/MR_Logo_revised.png" alt="Mason Row"></div>
			<?php } ?>
			...
			<div class="right">
                ...
                <div id="component_box_wrapper" class="modify-element-box-wrapper">
                    <div id="component_box" class="modify-element-box">
                        <p class="empty-appender">Add Design Elements</p>
                    </div>
                </div>
				<?php if ($container->simpleMode && $product->colorModel != '1_BIT') { ?>
		...
		<div class="wizard_footer">
			<a href='http://www.masonrow.com/terms-of-service' class='footer-link' target="_blank">Terms of Service</a>
		</div>
		<div id="hidden" style="display:none"></div>
	</div>
	
    <div id="dialog_confirm_message" title="Confirm" class="hidden">
        <p style="font-weight:bold">WARNING Custom made products are not returnable or refundable.</p>
        <p>You are about to create a customized product automatically made EXACTLY to YOUR specifications without additional proofreading or verification.</p>
        <p style="font-weight:bold">PLEASE REVIEW YOUR PROOF CAREFULLY.</p>
        <p>This application does NOT use any spell checking function, as such please carefully review the proof provided at the end of the personalization. Any errors or omissions (including blank fields) in your text will be incorporated in the finished product. Please ensure ALL of your information is included, such as your apartment #. If you do not see it on the final proof, it will not be on your finished product.</p>
        <p style="font-weight:bold">Please plan time sensitive dates to allow sufficient time to receive and use your custom product.</p>
    </div>
