...
function writeOrderDetails($ti, $container)
{
	...
	for($i=0; $i<count($container->designProductNames); $i++)
	{
		echo	'<tr><td class="product">'. htmlspecialchars($container->designProductNames[$i]) .
				'</td><td class="product">'. htmlspecialchars($container->designColors[$i]) .
				'</td></tr>';
	}
	echo '</table>';
}
...
<body unselectable="on" class="unselectable">
	...
	<div class="wizard_frame">
		<div class="wizard_header">
			<div class="wizard_header_title"><img src="<?php echo $ti->HOME_URL; ?>/images/logo/RTN_LogoHoriz.png" alt="RTNImagePro" width="400px" height="106px"></div>
		...
		<div class="wizard_body ui-widget-content confirm">
		    <table id="submitted_box" style="width:550px; margin-left: auto; margin-right: auto; margin-top: 40px;">
			   ...
			   <tr>
		            ...
		            <td>
		            	<p align="left">
		                I agree with the <a target="_blank" href="http://rtnimagepro.com/terms-of-service">terms of service</a>.
		                </p>
		            </td>
		       </tr>
		    </table>		
