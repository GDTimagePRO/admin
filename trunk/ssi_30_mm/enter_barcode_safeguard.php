<?php
	...
	$HOME_URL = "http://". Settings::HOME_URL . "enter_barcode_safeguard.php";
	...
	if(isset($_POST['code']))
	{		
		$customer = Common::$orderDB->getCustomerByKey("RGift");
	...
	<div id="code_box">
		<form method="post">
			<div id="interior_code">
				Code: &nbsp;&nbsp;
				<input type="text" name="code" placeholder="Product Code" required="required" value="PEERLESS" />
