...
function TextElement()
{
    ...
    this.setText = function(newText, newFont, newInverted)
    {
        ...
        {
        	this.drawable.pattern = new TextPattern( uiControlGroup.title ? uiControlGroup.title : "New text ...", font, scaleToFit, inverted, bold, italic, minSize, alignment, verticalAlignment);
        	this.drawable.displayGroup = Scene.DISPLAY_GROUP_ANY;
