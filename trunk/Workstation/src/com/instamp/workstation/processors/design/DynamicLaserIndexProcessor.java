...
public class DynamicLaserIndexProcessor  extends PrintProcessor {
	...
	private final String _name = "DynamicLaserIndex";
	...
	protected DynamicLaserIndexProcessor() {
		super("Dynamic Laser Index", "Print Dynamic Laser Index Designs", true);
	}
