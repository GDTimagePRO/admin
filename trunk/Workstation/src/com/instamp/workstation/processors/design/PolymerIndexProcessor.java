...
public class PolymerIndexProcessor extends PrintProcessor {
	...
	private final String _name = "PolymerIndex";
	
	private PageSizeMarginProcessorConfig configUI = null;
	private String _config = null;
	
	protected PolymerIndexProcessor() {
		super("Polymer Index", "Print Polymer Index Designs", true);
	}
