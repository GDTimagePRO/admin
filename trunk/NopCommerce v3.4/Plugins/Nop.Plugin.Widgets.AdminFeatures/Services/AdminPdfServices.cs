...
namespace Nop.Plugin.Widgets.AdminFeatures.Services
{
    class AdminPdfServices : Nop.Services.Common.PdfService
    {
        ...
        public AdminPdfServices(ILocalizationService localizationService, 
            ...
            IStoreContext storeContext, ISettingService settingContext, IWebHelper webHelper, 
            ...
            AddressSettings addressSettings, GeneSysWidgetSettings genesysSettings, ILogger logger) : base(localizationService, 
            languageService,
            workContext,
            orderService,
            paymentService,
