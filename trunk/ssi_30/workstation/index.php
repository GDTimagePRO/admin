...
function getTable($items,$type){
	...
	foreach ($items as $item){
		...
		$table .='<tr>
				<td><input name="selectedProduct'.$type.'" value="'.$item->image_id.'+'.$orderId.'+'.$item->color.'+'.$item->order_id.'+'.$item->product_id.'" type="checkbox" id="selectedProduct'.$type.'"></td>
...
<body>
    ...
    <div id="message">Creating PDF...</div>
        ...
        <ul id="menu">
            ...
            <li><a onClick="print(8)" style=" color: rgb(46, 110, 158); cursor: pointer;">Dynamic Laser</a></li>
