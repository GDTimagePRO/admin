...
{ 
    ...
    this.setText = function(newText, newFont, newInverted)
    {
        ...
        {
        	drawable.pattern = new TextPattern( uiControlGroup.title ? uiControlGroup.title : "New text ...", font, scaleToFit, inverted, bold, italic, minSize, alignment, verticalAlignment);
        	drawable.displayGroup = Scene.DISPLAY_GROUP_ANY;
...
//                  	{name: 'Pompadour'}
                  	{name: 'Gill Sans - Condensed'},
                  	{name: 'Liberator'},
                  	{name: 'Gill Sans MT'},
                  	{name: 'Gill Sans Light Italic'},
                  	{name: 'Gill Sans - Ultrabold'},
                  	{name: 'Gill Sans - Shadowed'},
                  	{name: 'Gill Sans - Shadowed Light'},
                  	{name: 'Gill Sans - Light'},
                  	{name: 'Gill Sans - Leftified'},
                  	{name: 'Gill Sans - Italic'},
                  	{name: 'Gill Sans - Extra Condensed Bold'},
                  	{name: 'Gill Sans - Extra Bold'},
                  	{name: 'alpha_echo'},
                  	{name: 'AMCAP Eternal'},
                  	{name: 'Copperplate'},
