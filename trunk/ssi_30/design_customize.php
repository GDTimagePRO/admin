<?php
	...
	{
		json_encode($_design_db->setDesignJSON($_POST['designId'], $_POST['stateJSON']));
				...
				_system.invokeWhenReady(function() {					
					...
					{												
						...
						$.get(previewImageQuery).done(function(){
							...
							if(hdImageUploaded && previewImageUploaded) navTo(_nav_next);
						}).fail(function(){
							didRespond = true;
							setTimeout(function() {
