...
{   
    ...
    points.middleMiddle.tags.allowVisible	= true;
    ...
    var updatePointVisibility = function()
    {
    	...
    	points.angle.visible = angleVisible;
        box.map = null;
    };
    ...
    this.setEditAllowMove = function(value)
    {
    	...
    	points.angle.editAllowMove = angleVisible;    	
    ...
    this.onDraw = function(params)
    {
        ...
        if(params.context)
        {
            ...
            for(var i in zorder)
            {
            	//TODO: Hide the middle point in a less hacky way 
            	if(points.middleMiddle !== zorder[i]) zorder[i].onDraw(params);
            }
