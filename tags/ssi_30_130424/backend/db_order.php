<?php
	...
	class ProcessingStage
	{
		...
		const STAGE_PENDING_RENDERING		= 300;
	...
	class OrderDB
	{
		...
		function createOrderItem(OrderItem $orderItem)
		{
			...
			$query = "INSERT INTO order_items(order_id, processing_stages_id, barcode, date_created, config_json, manufacturer_id, manufacturer_order_id, manufacturer_order_status) VALUES (";
			$query = $query.sprintf("%d, %d, '%s', NOW(), '%s', %d, %d, %d )",
					$orderItem->orderId,
