...
function UIPanel(propContainerId, listContainerId)
{
    ...
    {//$("#theId > div[id=thesearchid]"); 
        ...
        for(var i in groups)
        {
        	...
        	html += "<td><div id='" + id + "n' style='width:160px'>" + 
        			htmlEncode(params.description ? params.description : params.type) + 
        			"</div></td>";
        	//html += "<td><span id='" + id + "s' class='button objectbutton'>Select</span></td>";
        	//html += "<td><span id='" + id + "e' class='button objectbutton'>Edit</span></td>";
        	html += "<td><button id='" + id + "d' style='width:35px; height:22px;'></button></td>";        	
        ...
        {
        	var id = listTableId + i;
        	$("#" + id + "n").click(doSelect(i));
        	var deleteButton = $("#" + id + "d");
        	deleteButton.click(doRemove(i));
