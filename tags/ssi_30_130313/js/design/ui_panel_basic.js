...
//    		var btnbar_underline = element.find('#btnbar_underline').button();
//    		btnbar_underline.click( function() {    		
//    			alert("btnbar_underline");
//    		});
    		...
    		//tooltips
    		/*var text_size = element.find('#text_size');
    		makeTooltip(text_size, "Text size", elementTooltips);
    		var text_angle = element.find('#text_angle');
    		makeTooltip(text_angle, "Rotation", elementTooltips);
    		*/
    	};
