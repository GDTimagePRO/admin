...
<head>
	...
	<meta name="description" content="" />
  	...
  	<link type="text/css" href="css/themes/humanity/jquery-ui-1.10.1.custom.css?version=<?php echo $_version ?>" rel="stylesheet" />
	<link type="text/css" href="css/ps_design_wizard.css?version=<?php echo $_version ?>" rel="StyleSheet"/>	
	...
	<style>
		...
		{
			background: #666666; url(css/themes/humanity/images/ui-bg_glass_25_EA580C_1x400.png) 50% 50% repeat-x;
		}
				...
				_system.invokeWhenReady(function() {					
					...
					_system.saveCanvasAsImage(
						...
						function() 
						{
								...
								window.location = "ps_confirm_design.php";
						}, 
						function(value)
						{
...
<body unselectable="on" class="unselectable">
	<div class="wizard_frame">
		<a href="design_customize.php" style="position:absolute">link to Masonrow site</a>
		...
		<div class="wizard_body ui-widget-content">			
			<div class="controls_section">
				<div class="toolbar_pannel ui-widget-header">			
					<button style="margin-top:4px; width: 80px; margin-left:5px; float:left; font-size: 15px;" id="help"><span class="ui-button-text-head"><b>Help</b></span></button>					
					<button style="margin-top:4px; width: 80px; margin-left:8px; float:left;" id="undo"><span class="ui-button-text-head"><b>Undo</b></span></button>
					<button style="margin-top:4px; width: 80px; margin-left:5px; float:left;" id="redo"><span class="ui-button-text-head"><b>Redo</b></span></button>
					<?php if(!$_simple_mode){ ?>
						<button style="margin-top:4px; width: 120px; margin-right:7px; float:right;" id="addElement"><span class="ui-button-text-head">Add Element</span></button>					
					<?php } ?>
		...
		<div class="ui-widget-header ui-corner-all wizard_footer">
			...
			<button id="previousButton" name="previous" class="previous_button" value="previous"><span class="ui-button-text-head">Previous</span></button>
			<?php }?>
			<button id="nextButton" name="next" class="next_button" value="next"><span class="ui-button-text-head"><b>Next</b></span></button>
		</div>
	</div>
