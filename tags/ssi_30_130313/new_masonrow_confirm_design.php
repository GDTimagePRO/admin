...
<head>
	...
	<link type="text/css" href="css/masonrow_design_wizard.css" rel="StyleSheet"/>
...
<body unselectable="on" class="unselectable">
	<div class="wizard_frame">
		...
		<div class="ui-widget-header ui-corner-all wizard_footer">
			<button id="previousButton" name="previous" class="previous_button" value="previous" onclick="window.location = 'new_masonrow_design_customize.php'"><span class="ui-button-text-head"><b>Previous</b></span></button>
